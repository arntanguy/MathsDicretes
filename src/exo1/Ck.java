...
public abstract class Ck extends Frame {
  ...
  private class WindowHandler extends WindowAdapter {
   ...
   public void paint(Graphics g)
   {
     ...
     * Parametres: 
     *    int   x1 :la coordonnee en x de la premiere extremit�
     *    int  y1 : la coordonnee en y de la premiere extremit�
     *    int   x2 :la coordonnee en x de la deuxi�mee extremit�
     *    int  y2 : la coordonnee en y de la deuxi�me extremit�
     *    Graphics drawingArea : L'objet graphique dans lequel Ck est dessin�
     *        drawn 
     * Preconditions : x1,x2 sont compris entre 0 et w; y1 et y2 entre 0 et h;
     * Postcondition : Ck est dessin�
     **/ 
    public abstract  void drawCk(int x1, int y1, int x2, int y2, int k , 
